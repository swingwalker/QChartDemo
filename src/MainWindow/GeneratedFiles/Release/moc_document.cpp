...
QT_MOC_LITERAL(3, 18, 9), // "send_text"
QT_MOC_LITERAL(4, 28, 10), // "receiveMsg"
QT_MOC_LITERAL(5, 39, 11) // "receiveText"

    },
    "Document\0sendMsg\0\0send_text\0receiveMsg\0"
    "receiveText"
};
...
void Document::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->receiveMsg((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Document::sendMsg)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Document::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Document::receiveMsg)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Document::sendMsg(const QString & _t1)
{
...
// SIGNAL 1
void Document::receiveMsg(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
